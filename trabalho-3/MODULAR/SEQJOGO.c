...
/***************************************************************************
 *
 *  FunÃƒÂ§ÃƒÂ£o: SEQJ &Push carta do monte
 *****/

SEQJ_tpCondRet SEQJ_PushCartaMonte( SEQJ_tppSeqJ pSeqJ, CAR_tppCarta pCarta)
{
...
SEQJ_tpCondRet SEQJ_ViraCarta( SEQJ_tppSeqJ pSeqJ, int numCartas )
{
    ...
    //        pSeqJ->numCartasViradas++;
    //    }
//    int totalCartas = totalCartasNaSeq( pSeqJ );
//    if(totalCartas <= numCartas || ( numCartas > totalCartas - pSeqJ->numCartasViradas ) )
//    {
//        return 1;
//    }
